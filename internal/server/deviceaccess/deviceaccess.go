...
func (s *Server) Enable(ctx context.Context, req *pb.EnableRequest) (*pb.EnableResponse, error) {
	if _, err := s.send(ctx, req.SessionId, "DeviceAccess.enable", nil); err != nil {
...
func (s *Server) Disable(ctx context.Context, req *pb.DisableRequest) (*pb.DisableResponse, error) {
	if _, err := s.send(ctx, req.SessionId, "DeviceAccess.disable", nil); err != nil {
...
func (s *Server) SelectPrompt(ctx context.Context, req *pb.SelectPromptRequest) (*pb.SelectPromptResponse, error) {
	...
	if _, err := s.send(ctx, req.SessionId, "DeviceAccess.selectPrompt", params); err != nil {
...
func (s *Server) CancelPrompt(ctx context.Context, req *pb.CancelPromptRequest) (*pb.CancelPromptResponse, error) {
	...
	if _, err := s.send(ctx, req.SessionId, "DeviceAccess.cancelPrompt", params); err != nil {
